...
export default function CookiesPage() {
  const { cookies, lastUpdatedLegal } = marketingPages

  return (
    <PageShell
      eyebrow="Legal"
      title="Cookie policy"
      description="How we use cookies and similar technologies for sessions, preferences, and optional analytics."
    >
      ...
      <p className="mt-10 text-sm text-[#5c2f28]">
        Manage personal data requests through{' '}
